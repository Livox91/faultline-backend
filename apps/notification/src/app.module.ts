...
@Module({
  imports:[PlatformModule.forRoot('notification',resolve(__dirname,'../.env'))],controllers:[RetellWebhookController,VoiceActionController],providers:[
    ...
    RetellCommunicationProvider,{provide:COMMUNICATION_PROVIDER,useExisting:RetellCommunicationProvider},IncidentMessageBuilder,NotificationService,NotificationConsumer,VoiceActionService,LifecycleCommunicationService,RecoverySchedulerService,
  ],
